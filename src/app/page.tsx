    ...
    <div className="bg-sky-50 min-h-screen">
      ...
      <main className="max-w-5xl mx-auto px-4 py-16 flex flex-col md:flex-row items-center">
        <div className="md:w-1/2">
          ...
          <p className="mb-4 text-black">Целых пять лет я погружаюсь в мир IT в своей школе, накапливая знания и оттачивая навыки программирования. Я свободно владею тремя языками — Русским, Английским и своим родным Монгольским, что открывает мне двери для международных проектов и глобального общения в сфере технологий. Я полон амбиций и готов к новым вызовам! 🚀💻  </p>
          <a  className="text-white bg-blue-600 px-4 py-2 rounded">Отсосать</a>
        </div>
